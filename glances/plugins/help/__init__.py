    ...
    def generate_view_data(self):
        ...
        self.view_data.update(
            [
                ...
                ('show_hide_alert', msg_col.format('O', 'Alert logs')),
                ...
                ('show_hide_tcp_connection', msg_col.format('Y', 'TCP connections')),
                ...
                (
                    'misc_kill_process',
                    '' if self.args and self.args.webserver else msg_col.format('K', 'Kill process'),
                ),
                (
                    'misc_vim_navigation',
                    '' if self.args and self.args.webserver else msg_col.format('j/k', 'Navigate processes (vim)'),
                ),
                (
